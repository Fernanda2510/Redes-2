...
PORT = 9012 # Port to listen on (non-privileged ports are > 1023)
buffer_size = 1024

#Inicializar tablero de acuerdo a la dificultad ingresada
def IniciarTablero( nivel ):            #Se define la clase inicializar tablero
...
def Imprime Tablero():                          #Se define la clase imprimir tablero
    linea = ""
...
def VerificarTiro( tiroCliente, l):                    #Se define la clase verificar tiro
...
def MostrarMensaje( mensaje ):                  #Se define la clase mostrar mensaje
    input( mensaje )

def VerificarTablero(x, y, l):                  #Se define la clase verificar tablero
        ...
        with Client_conn:
            ...
            while( not JUEGO_TERMINADO):
                ...
                if(turnoServidor):
                    ...
                    tiroCliente = Client_conn.recv(1024)
